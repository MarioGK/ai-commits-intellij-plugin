...
class OpenAIService {
    ...
    fun generateCommitMessage(prompt: String, completions: Int): String {
//        val openAI = OpenAI(AppSettings.instance.getOpenAIConfig())
        // TODO @Blarc: Add proxy
        val openAI = OpenAiChatModel.builder()
            .apiKey(AppSettings.instance.getOpenAIToken())
            .modelName(AppSettings.instance.openAIModelId)
            .temperature(AppSettings.instance.openAITemperature.toDouble())
            .timeout(Duration.ofSeconds(AppSettings.instance.openAISocketTimeout.toLong()))
